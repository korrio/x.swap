        ...
        <StyledCardsWrapper>
          <StyledCardWrapper>
            <StyledInfo>
              ...
              of PHX held relative the weight of the staking. PHX can be minted
              by staking PHX. To redeem PHX staked plus swap fees convert PHX
              back to Sushi. {totalSupply ? `There are currently ${getBalanceNumber(totalSupply)} PHX in existence.` : '' }
            </StyledInfo>
          </StyledCardWrapper>
        </StyledCardsWrapper>
        <Spacer size="lg"/>
